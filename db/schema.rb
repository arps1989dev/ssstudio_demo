...
ActiveRecord::Schema.define(version: 20170621092813) do
  ...
  create_table "photographrs", force: :cascade do |t|
    t.string   "email"
    t.string   "fname"
    t.string   "lname"
    t.string   "phone"
  ...
  create_table "selected_photos", force: :cascade do |t|
    t.integer  "photo_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "water_marks", force: :cascade do |t|
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
